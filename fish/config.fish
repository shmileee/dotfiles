...
if grep -qE "(Microsoft|WSL)" /proc/version &>/dev/null
   ...
   function dnsfix
       ...
       set -lx ipv4dnsraw (/mnt/c/Windows/system32/netsh.exe interface ip show dns | tr -d '\r');
       set -lx ipv6dnsraw (/mnt/c/Windows/system32/netsh.exe interface ipv6 show dns | tr -d '\r');
